...
link_static_library_config = action_config(
    ...
    tools       = [
        tool(
            path                   = "/opt/devkitpro/devkitA64/bin/aarch64-none-elf-ar",
            tool                   = None,
            with_features          = [],
            execution_requirements = []
        )
...
strip_config = action_config(
    ...
    tools       = [
        tool(
            path                   = "/opt/devkitpro/devkitA64/bin/aarch64-none-elf-strip",
            tool                   = None,
            with_features          = [],
            execution_requirements = []
        )
...
def _cc_toolchain_config_info_generator_impl(ctx):
    gcc_system_include_directories = [
        ...
        "/opt/devkitpro/devkitA64/aarch64-none-elf/include/c++/13.1.0",
        "/opt/devkitpro/devkitA64/aarch64-none-elf/include/c++/13.1.0/aarch64-none-elf",
        "/opt/devkitpro/devkitA64/aarch64-none-elf/include/c++/13.1.0/backward",
        "/opt/devkitpro/devkitA64/lib/gcc/aarch64-none-elf/13.1.0/include",
        "/opt/devkitpro/devkitA64/lib/gcc/aarch64-none-elf/13.1.0/include-fixed",
    ...
    return cc_common.create_cc_toolchain_config_info(
        ...
        target_system_name              = "switch",
        target_cpu                      = "switch",
        target_libc                     = "unknown",
        compiler                        =
            "aarch64-none-elf-g++ (devkitA64 release 22) 13.1.0",
        abi_version                     = "unknown",
